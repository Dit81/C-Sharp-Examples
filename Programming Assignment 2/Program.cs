...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            sonic1 = Content.Load<Texture2D>("sonic1");
            sonic2 = Content.Load<Texture2D>("sonic2");
            sonic3 = Content.Load<Texture2D>("sonic3");

            // STUDENTS: set the currentSprite variable to one of your sprite variables
            currentSprite = sonic1;
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > CHANGE_DELAY_TIME)
            {
                ...
                {
                    currentSprite = sonic2;
                }
                else if (spriteNumber == 2)
                {
                    currentSprite = sonic3;
                }
