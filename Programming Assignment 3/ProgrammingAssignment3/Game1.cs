...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            greenrock = Content.Load<Texture2D>("greenrock") ;
            magentarock = Content.Load<Texture2D>("magentarock");
            whiterock = Content.Load<Texture2D>("whiterock");
