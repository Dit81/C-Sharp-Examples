        ...
        public void Update(GameTime gameTime, MouseState mouse, KeyboardState keyboard)
        {
            ...
            if (health > 0)
            {
               ...
               //  drawRectangle.X = mouse.X - drawRectangle.Width / 2;
                ...
                drawRectangle.X += (int)(velocity.X * GameConstants.BURGER_MOVEMENT_AMOUNT);
                drawRectangle.Y += (int)(velocity.Y * GameConstants.BURGER_MOVEMENT_AMOUNT);
                ...
                // keyboard space pressed is create a new projectile
                if (keyboard.IsKeyDown(Keys.Space) && canShoot == true)
                {
                    int xLoc = drawRectangle.Center.X;
                    int yLoc = drawRectangle.Center.Y - GameConstants.FRENCH_FRIES_PROJECTILE_OFFSET;
                    ...
                    xLoc, yLoc, GameConstants.FRENCH_FRIES_PROJECTILE_SPEED);
