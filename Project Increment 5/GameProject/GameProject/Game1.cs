...
namespace GameProject
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        // scoring support
        int score = 0;
        string scoreString = GameConstants.SCORE_PREFIX ;
        ...
        protected override void LoadContent()
        {
            ...
            healthString = GameConstants.HEALTH_PREFIX;
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            burger.Update(gameTime, mouse,  Keyboard.GetState());
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font, healthString + burger.Health.ToString(),
               GameConstants.HEALTH_LOCATION, Color.White,
               0, GameConstants.HEALTH_LOCATION, 1.0f, SpriteEffects.None, 0.5f);

            spriteBatch.DrawString(font, scoreString + score,
                GameConstants.HEALTH_LOCATION, Color.White,
                0, GameConstants.SCORE_LOCATION, 1.0f, SpriteEffects.None, 0.5f);
        ...
        private void CheckBurgerKill()
        {
            ...
            {
                burgerDead = true;
                burgerDeath.Play(1.0f, 0.0f, 0.0f);
            }
        }
